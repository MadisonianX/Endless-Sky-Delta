...
// Return how much ramscoop heat is generated by this system, depending on the given ship ramscoop heat value.
double System::RamscoopHeat(double shipRamscoopHeat, double scale) const
{
	return max(0., SolarWind() * .03 * scale * ramscoopMultiplier * (sqrt(shipRamscoopHeat)));
}
